...
export const projectImages = {
    ...
    Pizza: {
      ...
      description: "Pizza ordering app, developed with Tailwind CSS, offers a seamless user experience for ordering pizza online. Users can easily browse through a variety of pizzas, add them to their cart and securely checkout using their preferred payment method",  
      technologyUsed: {
        frontEnd: ['React'],  
        backend: [],
        styles: ['Tailwind']
    ...
    Safkiar: {
      ...
      description: "My first personal website built using JavaScript, featuring smooth animations, translations, and interactive sliders. The design is simple yet dynamic, with elements transitioning smoothly to enhance user interaction.",  
      technologyUsed: {
        frontEnd: ['JavaScript'],  
        backend: [],
        styles: ['CSS']
    ...
    Chess: {
      ...
      description: "Mini Chess is an innovative 6x8 adaptation of traditional chess, incorporating full game rules including castling, en passant, and pawn promotion. This streamlined version amplifies strategic intricacies by condensing the battlefield, compelling players to engage in complex tactics and maneuvers within a compact space. It stands as a testament to skillful game design and programming, ideal for those seeking to refine their chess strategy in a novel format.",  
      technologyUsed: {
        frontEnd: ['JavaScript'],  
        backend: [],
        styles: ['CSS']
    ...
    Kikowski: {
      dataCreated: "September 2024",  
      description: "Modern one-page React application with a sleek, responsive design and smooth scrolling. It features dark/light mode, efficient state management, and optimized performance for fast load times. Subtle animations enhance the user experience.", 
      technologyUsed: {
        frontEnd: ['React'],  
        backend: [],
        styles: ['Styled-components']
